...
const ClickableGitIcon = ({personal_github = "#"}) => {
    return (
        <>
            <a href={personal_github} className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="Github">
...
// const PersonCard_ = ({ name="Software engineer", description="Joseph Gonzalez", imgSrc, href }) => {
//     return(
//         <div className="flex flex-col overflow-hidden items-center p-3 transition-colors duration-200 transform cursor-pointer group hover:bg-amber-600 rounded-xl object-contain">
                        
//                                 <Image
//                                     key={name.id}
//                                     alt={name}
//                                     src="/../public/static/team/aran.jpeg"
//                                     className="mx-auto h-32 w-32 rounded-full object-cover object-center md:h-36 lg:h-48"
//                                     width={32}
//                                     height={32}
//                                     fill="true"
...
//                         src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt=""/> */}
...
// const ProfileCard = ({ name, description, imgSrc, href })  => {
//   return (
//         <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-blue-600 rounded-md">
//             <div className="flex flex-col p-2">
//             <Image
//                 key={name}
//                 className="w-880 h-880 rounded-full object-scale-down ring-4 ring-offset-1 ring-gray-300 responsive"
//                 src={imgSrc}
//                 alt={name}
//                 width={'140'}
//                 height={'140'}
...
//                 <h1 className="text-center mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">
//                     {name}
//                 </h1>
//                 <p className="text-center mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
//                     {description}
//                 </p>
//             </div>
//             <div className="flex mt-3 -mx-2">
...
const ProfileCard = ({ name, description, imgSrc, href }) => {
    return (
      <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-amber-500  rounded-md">
